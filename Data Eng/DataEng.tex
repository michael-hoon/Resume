...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Bachelor of Engineering, Engineering Systems and Design, Minor in Computer Science}{Singapore}
    \resumeSubheading
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {AI Software Engineer Intern}{Mar. 2024 -- Dec. 2024}
      {DSO National Laboratories}{Singapore}
      \resumeItemListStart
        \resumeItem{Deployed Retrieval Augmented Generation (RAG) pipeline for internal research assistant chatbot application with open-sourced tools, to provide intelligent responses based on large-scale unstructured data sources.}
        \resumeItem{Implemented Advanced Agentic RAG techniques incorporating DAG workflows with intelligent Plan-and-Solve prompt engineering, significantly improving reasoning capabilities compared to vanilla RAG pipelines.} 
        \resumeItem{Optimised Data Pre-processing, Generation, and Retrieval pipelines through a comprehensive literature review of state of the art NLP techniques, to improve retrieval relevancy and ensure quality generated answers.} 
        \resumeItem{Participated in deploying the model within the company's IT platforms, ensuring scalability and performance.}
    ...
    \vspace{-12pt}
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Integrated the system with SQL databases to store and retrieve data on the Microsoft Azure Cloud platform, enabling scalable and secure cloud-based data storage.}
          \resumeItemListEnd
      % \resumeProjectHeading
