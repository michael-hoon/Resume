...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Natural Language Processing Engineer Intern}{Mar. 2024 -- Present}
      {DSO National Laboratories}{Singapore}
      \resumeItemListStart
        \resumeItem{Building production-ready Retrieval Augmented Generation pipeline for ingesting of multiple unstructured documents, with open-sourced local LLMs via Ollama, }
        \resumeItem{} 
        \resumeItem{}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Developed end-to-end automated pipeline solution with bash scripting, integrating existing database with Python and Power BI.} 
